...
namespace Aml.Editor.Plugin.Sandbox.Views
{
    /// <summary>
    /// Interaction logic for AMLLibraryView.xaml
    /// </summary>
    public partial class AMLLibraryView : UserControl
    {
        public AMLLibraryView()
        {
            InitializeComponent();
        }
    }
