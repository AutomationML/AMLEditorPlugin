...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "AutomationML eV" /productName "AutomationMLEditor" /mediaBookList "The AutomationML Editor PlugIn Implementation Guide"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "AutomationML eV" /productName "AutomationMLEditor" /bookList "The AutomationML Editor PlugIn Implementation Guide"
